...
#RUN BR2_EXTERNAL=/root/licheepi-nano make sdl2 -e EXTRA_CONF_OPTS="--enable-video-fbcon --enable-video-dummy --disable-video-x11"

#RUN BR2_EXTERNAL=/root/licheepi-nano make nos
